...
const Contact = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-8">
      ...
      <div hidden={!submitted} role="alert" className="bg-light-green rounded-lg text-white p-2">
        {message}
      </div>

      <form className="flex flex-col dark:bg-gray-800 bg-white gap-2 shadow-lg p-6" onSubmit={formik.handleSubmit}>
        ...
        <div className="flex flex-row justify-between gap-3 flex-wrap">
          ...
          <label htmlFor="company" className="flex flex-col flex-1">
            ...
            <input
              ...
              onBlur={formik.handleBlur}
            />
            <span>{formik.errors.company && <div>{formik.errors.company}</div>}</span>
          </label>
        </div>
